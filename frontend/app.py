...
def run_train_and_explain(job_id: str, params: dict):
    ...
    try:
        ...
        exp = llm_explainer.explain_instance(
            ...
            labels=(pred_label_idx,) if hasattr(model, 'predict_proba') else None,
        ...
        jobs[job_id]['class_names'] = current_dataset_info.get('class_names')
        ...
        exp.save_to_file(str(outpath), labels=(pred_label_idx,) if hasattr(model, 'predict_proba') else None)
