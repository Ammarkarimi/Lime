...
# LLM Configuration
DEFAULT_LLM_MODEL = "gpt-4o-mini"  # More cost-effective than gpt-4
DEFAULT_ANTHROPIC_MODEL = "claude-3-haiku-20240307"  # Fast and cost-effective

# API Settings
MAX_RETRIES = 3
TIMEOUT_SECONDS = 30
CACHE_RESPONSES = True  # Cache LLM responses for similar prompts
